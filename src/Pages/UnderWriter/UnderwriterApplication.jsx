...
export default function UnderwriterApplication(){
            ...
            <div className="flex flex-col justify-between w-[95%] gap-4 items-start">
              <div className="mb-[1rem] flex gap-4 justify-between w-[70%]">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <Link to="/application/underwriter/overview" className="bg-[#4AACD5] text-[0.9rem] text-white px-[1.2rem] py-[0.3rem]">
                        Add Application
                    </Link>
                </div>
              </div>
              <div className="flex items-center justify-between text-[#434343] w-[95%] ">
